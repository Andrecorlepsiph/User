...
console.log(`Module ${module} Siap Untuk Running...`)
...
require('../config')
nocache('../config', module => console.log(chalk.greenBright('[ WHATSAPP BOT ]  ') + time + chalk.cyanBright(` "${module}" Telah diupdate!`)))
